    ...
    render() {
        return (
            <div className="search-section" id="search">
                <h1 style={{color:"#B40404", textAlign:"center", fontSize:70}}>SEARCH</h1>
                <div style={styling}>
                    <p style={{color:"white", fontSize:35, textAlign:"center"}}>Find your Partner</p>
                    ...
                    <div style={{ height: 600 }}>
                        ...
                        <div className="container">
                            ...
                            <div className="col-md-12">
                                <h4 style={{textAlign:"center"}}>Search Your Partner</h4>
                                </div>
                            <div className="col-md-3">
                                ...
                                }} color="danger" size="sm" className={styles.button}>Search</Button>{" "}
                                <br></br>
                                </div>
                                <div className="col-md-12">
                                <br></br>
